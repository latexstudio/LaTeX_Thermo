...
%	\setCJKfamilyfont{黑体}{华文细黑}
%	\newcommand{\myHeavy}{\fontspec{Segoe UI Semilight} \CJKfamily{黑体}}
	\setCJKfamilyfont{黑体}{华文黑体}
	\newcommand{\myHeavy}{\fontspec{MyriadPro-Regular} \CJKfamily{黑体}}
	\newcommand{\myBold}{\bfseries \CJKfamily{中宋}}
...
%\usepackage{ctex} %已经使用了ctexbook文档类
	...
	\ctexset{
		part = {
			format = {\myBold \Huge \centering},
			name = {第, 篇}
		},
		chapter = {
			format = {\myBold \LARGE \raggedright},
		},
		section = {
			format = {\myBold \Large \centering},
		},
		subsection = {
			format = {\myBold},
			name = {,、\hspace{-1 em}},
